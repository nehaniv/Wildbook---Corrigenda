...
Correction added December 2025:\\[1ex]
p. 166 line 9. \\

\nonindent ``Let $A_1 = V \cap (V(L_1) \cup \dots \cup V(L_m))$ and $A_2 =
V - (V(L_1) \cup \dots \cup V(L_m)) \subseteq V(L_{m+1})$. ''\\

should read:\\

\noindent
``Let $A_1 = A \cap (V(L_1) \cup \dots \cup V(L_m))$ and $A_2 =
A - (V(L_1) \cup \dots \cup V(L_m)) \subseteq V(L_{m+1})$. ''
